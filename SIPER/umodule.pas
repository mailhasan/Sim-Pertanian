...
type
  ...
  TFmodule = class(TForm)
    ...
    procedure SQLAsetketeranganGetText(Sender: TField; var aText: string;
      DisplayText: Boolean);
...
procedure TFmodule.SQLAsetketeranganGetText(Sender: TField; var aText: string;
  DisplayText: Boolean);
begin
  Text := Copy(SQLAsetketerangan.AsString, 1, 200);
end;
